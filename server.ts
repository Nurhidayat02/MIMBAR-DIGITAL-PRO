...
Tulis naskah khutbah/ceramah secara lengkap dan detil, bukan ringkasan. Berikan harokat lengkap pada teks Arab (terutama ayat atau kutipan hadits) agar mudah dibaca oleh khatib/pembicara.
`;
...
Format output harus selalu JSON valid sesuai schema yang diminta.
`;
